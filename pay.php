...
if (isset($_POST['submit'])) {
    ...
    $CallBackURL = 'https://shrouded-meadow-45282-36291630ca1c.herokuapp.com/callback.php';
    ...
    // Save to file or DB for tracking
    file_put_contents("latest_payment.json", json_encode($responseData));

    echo json_encode([
        'ResponseCode' => $responseData['ResponseCode'] ?? '1',
        'CustomerMessage' => $responseData['CustomerMessage'] ?? 'STK Push failed',
